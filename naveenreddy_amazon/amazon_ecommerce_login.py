...
CONFIGS = {"Driver": webdriver.Chrome("/usr/lib/chromium-browser/chromedriver"),
           ...
           "username": "naveenknkn7@gmail.com",
           }

# Reading the data from the text file and storing it inside a variable
with open('/home/kamasani/Desktop/18june/passwod.txt', 'r') as fp:
    password = fp.read()
...
# Script name               :       amazon_ecommerce_login.py
# Script version            :       1.0
# Prepared By               :       Kamasani Naveen Reddy
